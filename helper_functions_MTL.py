...
def build_model(
    ...
    if model_name == "resnet18":
        ...
        model.fc = MultiTaskHead(num_ftrs, num_classes, dropout_rate, use_regularization)
        ...
        model.classifier[2] = MultiTaskHead(num_ftrs, num_classes, dropout_rate, use_regularization)
